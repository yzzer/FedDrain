...
input_dir = "../../data/splitted_fed_brain/"  # The input directory of log file
input_dir_test = "../../data/loghub_2k/"
output_dir = "Brain_result_fed_2k/"  # The output directory of parsing results
chunk_num = 7
...
benchmark_settings = {
    ...
    "Hadoop": {
        ...
        "regex": [r"\/(?:[a-zA-Z0-9_.-]+\/)+[a-zA-Z0-9_.-]+", r"(\d+\.){3}\d+"],
        "delimiter": [],
        "theshold": 6,
        "st": 0.5,
        "depth": 4,
