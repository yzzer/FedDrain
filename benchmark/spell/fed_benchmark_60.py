...
input_dir = "../../data/splitted—spell_60/"  # The input directory of log file
input_dir_test = "../../../dataset/"
output_dir = "Spell_result_fed_60/"  # The output directory of parsing results
chunk_num = 60
...
print(df_result)
df_result.to_csv("Spell_bechmark_result_60.csv", float_format="%.6f")
